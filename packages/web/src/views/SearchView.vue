  ...
  <div class="max-w-3xl mx-auto min-h-[calc(100vh-8rem)] pb-20">
    <div class="text-center py-8">
      ...
      <div class="relative max-w-2xl mx-auto group">
        <Search
          class="w-6 h-6 absolute left-4 top-3.5 text-gray-400 group-focus-within:text-[#0D9488] transition-colors"
        />
        <input
          v-model="searchQuery"
    ...
    <div v-if="hasSearched && !loading" class="mt-8 space-y-8 animate-in fade-in duration-300">
      ...
      >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          >
            <div
              class="w-10 h-10 rounded-md bg-[#F0FDFA] text-[#0D9488] flex items-center justify-center mr-3 shrink-0"
            >
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <div class="flex justify-between items-start">
              ...
              <span v-if="node.node_date" class="text-xs text-gray-400 ml-2 shrink-0">{{
